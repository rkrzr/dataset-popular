...
var page_site = 'default_collection';
var page_client = 'default_frontend';
var access_val = 'p';
var google_uri = 'http://google.americanheart.org/suggest';
...
function ss_composeSuggestUri(qVal, suggestForm) {
  var siteVal = page_site;
  var clientVal = page_client;
  var accessVal = access_val;
  var uri = google_uri;
...
function ss_suggest(qVal) {
  ...
  var newUrl="/HEARTORG/common/autoSearch.jsp?google_url="+url;
  ...
  XH_XmlHttpPOST(xmlhttp, newUrl, '', handler);
}
