...
function WebTrends(){
	...
	} else if (host.search('saworldview.com$')!=-1) {
	  this.dcsid="dcst1kr4uvz5bdrdygoo2t7rh_3r7q";
	  this.fpcdom=".saworldview.com";
