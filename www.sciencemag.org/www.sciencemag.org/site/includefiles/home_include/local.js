...
(function() {
  ...
  mf.src = "//cdn.mouseflow.com/projects/52b6f0a4-bbbf-495b-997e-9b0247aae11b.js";
  document.getElementsByTagName("head")[0].appendChild(mf);
})();
*/

/*MOUSE TRACKING HEATMAP - TRIAL PERIOD EXPIRED 3/18/2013
(function() {
  var host = ('https:' == document.location.protocol ? 'https://ssl.' : 'http://met.');
  var uriSuffix = 'picnet.com.au/resources/scripts/' + 'met.client.min.js?usercode=276740385521696';
...
$(function() { 
  ...
  //Set up News Feed RSS reader
  $('#sci-news-minifeed').rssfeed('http://news.sciencemag.org/rss/current.xml?v=2', {
    limit: 4
  });
    
  //Chrome Voice Search
  //$("#search-terms").unbind('blur').unbind('focus');
  //$('#search-terms').val('').attr('x-webkit-speech',''); 
...
(function($){
    ...
    base.buildNextBackButtons = function(){
      var $forward = $('<a class="arrow forward">Next</a>'),
        $back    = $('<a class="arrow back">Previous</a>');
