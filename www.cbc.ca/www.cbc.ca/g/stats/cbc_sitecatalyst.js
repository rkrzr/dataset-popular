...
var s_account = ( 'undefined' != typeof( stats_reporting_suite ) )
              ? stats_reporting_suite
              : "cbc-production";
              
var s_cbc_sitecatalyst=s_gi(s_account);

// Init site catalyst object
var s_cbc_sitecatalyst_init = function(sc_obj) {

/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
/* Character Set */
sc_obj.charSet = "UTF-8";
/* Conversion Config */
sc_obj.currencyCode="USD";
/* Link Tracking Config */
sc_obj.trackDownloadLinks=true;
sc_obj.trackExternalLinks=true;
sc_obj.trackInlineStats=true;
sc_obj.linkDownloadFileTypes="exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx,asx";
sc_obj.linkInternalFilters="javascript:,cbc.ca,matthewhughes.ca";
sc_obj.linkLeaveQueryString=false;
sc_obj.linkTrackVars="None";
sc_obj.linkTrackEvents="None";
/* Plugin Config */

/* Daylight Savings Time */
sc_obj.dstStart="03/10/2013";
sc_obj.dstEnd="11/03/2013";
sc_obj.currentYear="2013";

/* Form Analysis Config (should be above doPlugins section) */
sc_obj.formList="";
sc_obj.trackFormList=true;
sc_obj.trackPageName=true;
sc_obj.useCommerce=false;
sc_obj.varUsed="prop19";
sc_obj.eventList=""; //Abandon,Success,Error
sc_obj.usePlugins=true;

function s_cbc_sitecatalyst_doPlugins(sc_obj) {
...
/* Site Search */
if(sc_obj.prop7){
        sc_obj.prop7=sc_obj.prop7.toLowerCase();
        sc_obj.eVar7="D=c7";
        var t_search=sc_obj.getValOnce(sc_obj.eVar7,'ev7',0);
        if(t_search){
               sc_obj.events=sc_obj.apl(sc_obj.events,"event1",",",2);
        }
}

sc_obj.setupFormAnalysis();

sc_obj.hbx_lt = "auto"; // manual, auto
sc_obj.setupLinkTrack("prop21,prop22,prop23,prop24","SC_LINKS");
...
if(!sc_obj.prop8&&!sc_obj.eVar8) sc_obj.prop8=sc_obj.eVar8=sc_obj.getTimeParting('h','-5'); // Set hour 
if(!sc_obj.prop9&&!sc_obj.eVar9) sc_obj.prop9=sc_obj.eVar9=sc_obj.getTimeParting('d','-5'); // Set day 
if(!sc_obj.prop10&&!sc_obj.eVar10) sc_obj.prop10=sc_obj.eVar10=sc_obj.getTimeParting('w','-5'); // Set weekday 

sc_obj.prop16 = sc_obj.getNewRepeat(365,'s_nr2');

/* Copy props to eVars */
if(sc_obj.prop1&&!sc_obj.eVar1) sc_obj.eVar1="D=c1"; 
if(sc_obj.prop2&&!sc_obj.eVar2) sc_obj.eVar2="D=c2";  
if(sc_obj.prop3&&!sc_obj.eVar3) sc_obj.eVar3="D=c3";
if(sc_obj.prop4&&!sc_obj.eVar4) sc_obj.eVar4="D=c4";
if(sc_obj.prop5&&!sc_obj.eVar5) sc_obj.eVar5="D=c5";
if(sc_obj.prop6&&!sc_obj.eVar6) sc_obj.eVar6="D=c6";
if(sc_obj.prop7&&!sc_obj.eVar7) sc_obj.eVar7="D=c7";
 
if(sc_obj.pageName&&!sc_obj.eVar11) sc_obj.eVar11=sc_obj.pageName;
if(sc_obj.channel&&!sc_obj.eVar12) sc_obj.eVar12="D=ch";
 
if(sc_obj.prop11&&!sc_obj.eVar22) sc_obj.eVar22="D=c11";
if(sc_obj.prop15&&!sc_obj.eVar15) sc_obj.eVar15="D=c15";
if(sc_obj.prop16&&!sc_obj.eVar16) sc_obj.eVar16="D=c16";
if(sc_obj.prop17&&!sc_obj.eVar17) sc_obj.eVar17="D=c17";
if(sc_obj.prop18&&!sc_obj.eVar18) sc_obj.eVar18="D=c18";
 
if(sc_obj.purchaseID&&!sc_obj.eVar19) sc_obj.eVar19=sc_obj.purchaseID;
 
if(sc_obj.prop25&&!sc_obj.eVar25) sc_obj.eVar25="D=c25";
if(sc_obj.prop26&&!sc_obj.eVar26) sc_obj.eVar26="D=c26";
if(sc_obj.prop27&&!sc_obj.eVar27) sc_obj.eVar27="D=c27";
if(sc_obj.prop28&&!sc_obj.eVar28) sc_obj.eVar28="D=c28";
 
if(sc_obj.prop32&&!sc_obj.eVar32) sc_obj.eVar32="D=c32";
if(sc_obj.prop33&&!sc_obj.eVar33) sc_obj.eVar33="D=c33";
if(sc_obj.prop34&&!sc_obj.eVar34) sc_obj.eVar34="D=c34";
if(sc_obj.prop35&&!sc_obj.eVar35) sc_obj.eVar35="D=c35";
if(sc_obj.prop36&&!sc_obj.eVar36) sc_obj.eVar36="D=c36";
if(sc_obj.prop37&&!sc_obj.eVar37) sc_obj.eVar37="D=c37";
 
if(sc_obj.prop40&&!sc_obj.eVar40) sc_obj.eVar40="D=c40";
if(sc_obj.prop41&&!sc_obj.eVar41) sc_obj.eVar41="D=c41";
if(sc_obj.prop42&&!sc_obj.eVar42) sc_obj.eVar42="D=c42";
 
if(sc_obj.prop44&&!sc_obj.eVar44) sc_obj.eVar44="D=c44";
if(sc_obj.prop45&&!sc_obj.eVar45) sc_obj.eVar45="D=c45";
if(sc_obj.prop46&&!sc_obj.eVar46) sc_obj.eVar46="D=c46";
if(sc_obj.prop47&&!sc_obj.eVar47) sc_obj.eVar47="D=c47";
if(sc_obj.prop48&&!sc_obj.eVar48) sc_obj.eVar48="D=c48";

sc_obj.socialPlatforms('eVar52');
}
sc_obj.doPlugins=s_cbc_sitecatalyst_doPlugins
/************************** PLUGINS SECTION *************************/
...
var gigya_omniture_conf = { 
	...
	eventMap : [ 
	{
		gigEvent:"login",
		omtrEvents:["event12"],
		mapVars:["eVar31=user.loginProvider", "eVar33=getAge()", "eVar33=getGender()", "eVar32=getiRank()"] 
	}, 
	{
		gigEvent:"sendDone",
		omtrEvents:["event13"],
		mapVars:["eVar34=providers","products"] 
	}, 
	{
		gigEvent:"commentSubmitted",
		omtrEvents:["event14"], 
		mapVars:["eVar34=getCommentProviders()","products"] 
	},
	{
		gigEvent:"reactionClicked",
		omtrEvents:["event15"], 
		mapVars:["eVar35=reaction.ID","products"] 
	} 	
	],
 ...
 */
if(!sc_obj.__ccucr){sc_obj.c_rr=sc_obj.c_r;sc_obj.__ccucr = true;
sc_obj.c_r=new Function("k",""
 ...
 */
if(!sc_obj.__ccucw){sc_obj.c_wr=sc_obj.c_w;sc_obj.__ccucw = true;
sc_obj.c_w=new Function("k","v","e",""
+"this.new2 = true;"
 ...
 */
sc_obj.getTimeParting=new Function("t","z",""
 ...
 */
sc_obj.getQueryParam=new Function("p","d","u",""
+"var s=this,v='',i,t;d=d?d:'';u=u?u:(s.pageURL?s.pageURL:s.wd.locati"
+"on);if(u=='f')u=s.gtfs().location;while(p){i=p.indexOf(',');i=i<0?p"
+".length:i;t=s.p_gpv(p.substring(0,i),u+'');if(t)v+=v?d+t:t;p=p.subs"
+"tring(i==p.length?i:i+1)}return v");
sc_obj.p_gpv=new Function("k","u",""
+"var s=this,v='',i=u.indexOf('?'),q;if(k&&i>-1){q=u.substring(i+1);v"
+"=s.pt(q,'&','p_gvf',k)}return v");
sc_obj.p_gvf=new Function("t","k",""
 ...
 */
sc_obj.getValOnce=new Function("v","c","e",""
+"var s=this,k=s.c_r(c),a=new Date;e=e?e:0;if(v){a.setTime(a.getTime("
+")+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v");
/*
 * Utility Function: split v1.5 - split a string (JS 1.0 compatible)
 */
sc_obj.split=new Function("l","d",""
+"var i,x=0,a=new Array;while(l){i=l.indexOf(d);i=i>-1?i:l.length;a[x"
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");
/*
 * Plugin Utility: apl v1.1
 */
sc_obj.apl=new Function("L","v","d","u",""
 ...
 */
sc_obj.getNewRepeat=new Function("d","cn",""
 ...
 *         
 *         Updated to truncate link text at 50 chars Sept 27, 2010
 */
sc_obj.setupLinkTrack=new Function("vl","c",""
...
sc_obj._IL=new Function("a","var s=this;return a!='undefined'?a.length:0");
sc_obj._II=new Function("a","b","c","var s=this;return a.indexOf(b,c?c:0)"
);
sc_obj._IS=new Function("a","b","c",""
+"var s=this;return b>s._IL(a)?'':a.substring(b,c!=null?c:s._IL(a))");
sc_obj._LN=new Function("a","b","c","d",""
+"var s=this;b=a.href;b+=a.name?a.name:'';c=s._LVP(b,'lid');d=s._LVP("
+"b,'lpos');r"
+"eturn[c,d]");
sc_obj._LVP=new Function("a","b","c","d","e",""
+"var s=this;c=s._II(a,'&'+b+'=');c=c<0?s._II(a,'?'+b+'='):c;if(c>-1)"
+"{d=s._II(a,'&',c+s._IL(b)+2);e=s._IS(a,c+s._IL(b)+2,d>-1?d:s._IL(a)"
+");return e}return ''");
sc_obj._LS=new Function("a",""
+"var s=this,b,c=100,d,e,f,g;b=(s._IL(a)>c)?escape(s._IS(a,0,c)):esca"
+"pe(a);b=s._LSP(b,'%0A','%20');b=s._LSP(b,'%0D','%20');b=s._LSP(b,'%"
+"09','%20');c=s._IP(b,'%20');d=s._NA();e=0;for(f=0;f<s._IL(c);f++){g"
+"=s._RP(c[f],'%20','');if(s._IL(g)>0){d[e++]=g}}b=d.join('%20');retu"
+"rn unescape(b)");
sc_obj._LSP=new Function("a","b","c","d","var s=this;d=s._IP(a,b);return d"
+".join(c)");
sc_obj._IP=new Function("a","b","var s=this;return a.split(b)");
sc_obj._RP=new Function("a","b","c","d",""
+"var s=this;d=s._II(a,b);if(d>-1){a=s._RP(s._IS(a,0,d)+','+s._IS(a,d"
+"+s._IL(b),s._IL(a)),b,c)}return a");
sc_obj._TL=new Function("a","var s=this;return a.toLowerCase()");
sc_obj._NA=new Function("a","var s=this;return new Array(a?a:0)");
sc_obj._hbxm=new Function("m","var s=this;return (''+m).indexOf('{')<0");
sc_obj._hbxln=new Function("h","var s=this,n=s.linkNames;if(n)return s.pt("
+"n,',','lnf',h);return ''");
 ...
 */
sc_obj.setupFormAnalysis=new Function(""
+"var s=this;if(!s.fa){s.fa=new Object;var f=s.fa;f.ol=s.wd.onload;s."
+"wd.onload=s.faol;f.uc=s.useCommerce;f.vu=s.varUsed;f.vl=f.uc?s.even"
+"tList:'';f.tfl=s.trackFormList;f.fl=s.formList;f.va=new Array('',''"
+",'','')}");
sc_obj.sendFormEvent=new Function("t","pn","fn","en",""
+"var s=this,f=s.fa;t=t=='s'?t:'e';f.va[0]=pn;f.va[1]=fn;f.va[3]=t=='"
+"s'?'Success':en;s.fasl(t);f.va[1]='';f.va[3]='';");
sc_obj.faol=new Function("e",""
+"var s=s_c_il["+sc_obj._in+"],f=s.fa,r=true,fo,fn,i,en,t,tf;if(!e)e=s.wd."
...
sc_obj.faos=new Function("e",""
+"var s=s_c_il["+sc_obj._in+"],f=s.fa,su;if(!e)e=s.wd.event;if(f.vu){s[f.v"
+"u]='';f.va[1]='';f.va[3]='';}su=f.os[this.name];return su?su(e):tru"
+"e;");
sc_obj.fasl=new Function("e",""
+"var s=s_c_il["+sc_obj._in+"],f=s.fa,a=f.va,l=s.wd.location,ip=s.trackPag"
...
+"ul(e):true;");
sc_obj.fam=new Function("e",""
+"var s=s_c_il["+sc_obj._in+"],f=s.fa;if(!e) e=s.wd.event;var o=s.trackLas"
...
+"d(e);");
sc_obj.ee=new Function("e","n",""
+"return n&&n.toLowerCase?e.toLowerCase()==n.toLowerCase():false;");
sc_obj.fage=new Function("e","a",""
+"var s=this,f=s.fa,x=f.cnt;x=x?x+1:1;f.cnt=x;return x==a?e:'';");

/* START: ClickTale */
sc_obj.maxDelay=750
sc_obj.loadModule("Integrate")

sc_obj.Integrate.onLoad=function(s,m){
	/* BEGIN: ClickTale */
	sc_obj.Integrate.add("ClickTale");
	sc_obj.Integrate.ClickTale.sessionVar="eVar41";
	sc_obj.Integrate.ClickTale.setVars=function(s,p){
		if(typeof ClickTaleGetUID=='function'){
			sc_obj[p.sessionVar]=ClickTaleGetUID()
		}
	}
	sc_obj.Integrate.ClickTale.delay();
	/* END: ClickTale */
}

/* Configure Modules and Plugins */

sc_obj.loadModule("Media")
sc_obj.Media.autoTrack=false
sc_obj.Media.trackWhilePlaying=true
sc_obj.Media.trackVars="None"
sc_obj.Media.trackEvents="None"

/* WARNING: Changing any of the below variables will cause drastic
changes to how your visitor data is collected.  Changes should only be
made when instructed to do so by your account manager.*/
sc_obj.visitorNamespace="cbcca"
sc_obj.trackingServer="metrics.cbc.ca"
sc_obj.trackingServerSecure="smetrics.cbc.ca"

/****************************** MODULES *****************************/
/* Module: Media */
sc_obj.m_Media_c="var m=s.m_i('Media');m.cn=function(n){var m=this;return m.s.rep(m.s.rep(m.s.rep(n,\"\\n\",''),\"\\r\",''),'--**--','')};m.open=function(n,l,p,b){var m=this,i=new Object,"
 ...
 */
sc_obj.socialPlatforms=new Function("a",""
...
sc_obj.socPlatList="facebook.com>Facebook|twitter.com>Twitter|t.co/>Twitter|youtube.com>Youtube|clipmarks.com>Clipmarks|dailymotion.com>Dailymotion|delicious.com>Delicious|digg.com>Digg|diigo.com>Diigo|flickr.com>Flickr|flixster.com>Flixster|fotolog.com>Fotolog|friendfeed.com>FriendFeed|google.com/buzz>Google Buzz|buzz.googleapis.com>Google Buzz|plus.google.com>Google+|hulu.com>Hulu|identi.ca>identi.ca|ilike.com>iLike|intensedebate.com>IntenseDebate|myspace.com>MySpace|newsgator.com>Newsgator|photobucket.com>Photobucket|plurk.com>Plurk|slideshare.net>SlideShare|smugmug.com>SmugMug|stumbleupon.com>StumbleUpon|tumblr.com>Tumblr|vimeo.com>Vimeo|wordpress.com>WordPress|xanga.com>Xanga|metacafe.com>Metacafe|";

/*  
 * socialAuthors v1.3
 */
sc_obj.socialAuthors=new Function("",""
+"var sc_obj=this,g,tco;g=sc_obj.referrer?sc_obj.referrer:document.referrer;if(g.ind"
+"exOf('t.co/')!=-1){sc_obj.tco=escape(sc_obj.split(g,'/')[3]);sc_obj.Integrate.add("
+"'SocialAuthor');sc_obj.Integrate.SocialAuthor.tEvar='eVar53';sc_obj.Integrate" //Update eVar here.
+".SocialAuthor.get('search.twitter.com/search.json?var=[VAR]&"
+"callback=s_cbc_sitecatalyst.twitterSearch&q=http%3A%2F%2Ft.co%2F'+sc_obj.tco);sc_obj.Integrate"
+".SocialAuthor.delay();sc_obj.Integrate.SocialAuthor.setVars=function(sc_obj,p"
+"){sc_obj[p.tEvar]=sc_obj.user;}}");
sc_obj.twitterSearch=new Function("obj",""
+"var sc_obj=this,txt,txtRT,txtEnd,txtAuthor;txt=obj.results[0].text;txtRT"
+"=txt.indexOf('RT @');if(txtRT!=-1){txtEnd=txt.indexOf(' ',txtRT+4);"
+"txtAuthor=txt.substring(txtRT+4,txtEnd);sc_obj.user=txtAuthor.replace(':"
+"','');}else{sc_obj.user=obj.results[0].from_user;}sc_obj.Integrate.SocialAuth"
+"or.ready();");

sc_obj.maxDelay='1000';	//max time to wait for 3rd party api response in milliseconds
sc_obj.loadModule("Integrate")
sc_obj.Integrate.onLoad=function(s,m){
	sc_obj.socialAuthors();
};

/* Module: Integrate */
sc_obj.m_Integrate_c="var m=s.m_i('Integrate');m.add=function(n,o){var m=this,p;if(!o)o='s_Integrate_'+n;if(!m.s.wd[o])m.s.wd[o]=new Object;m[n]=new Object;p=m[n];p._n=n;p._m=m;p._c=0;p._"
+"d=0;p.disable=0;p.get=m.get;p.delay=m.delay;p.ready=m.ready;p.beacon=m.beacon;p.script=m.script;m.l[m.l.length]=n};m._g=function(t){var m=this,s=m.s,i,p,f=(t?'use':'set')+'Vars',tcf;for(i=0;i<m.l.l"
+"ength;i++){p=m[m.l[i]];if(p&&!p.disable&&p[f]){if(s.apv>=5&&(!s.isopera||s.apv>=7)){tcf=new Function('s','p','f','var e;try{p[f](s,p)}catch(e){}');tcf(s,p,f)}else p[f](s,p)}}};m._t=function(){this."
+"_g(1)};m._fu=function(p,u){var m=this,s=m.s,v,x,y,z,tm=new Date;if(u.toLowerCase().substring(0,4) != 'http')u='http://'+u;if(s.ssl)u=s.rep(u,'http:','https:');p.RAND=Math&&Math.random?Math.floor(Ma"
+"th.random()*10000000000000):tm.getTime();p.RAND+=Math.floor(tm.getTime()/10800000)%10;x=0;while(x>=0){x=u.indexOf('[',x);if(x>=0){y=u.indexOf(']',x);if(y>x){z=u.substring(x+1,y);if(z.length>2&&z.su"
+"bstring(0,2)=='s.'){v=s[z.substring(2)];if(!v)v=''}else{v=''+p[z];if(!(v==p[z]||parseFloat(v)==p[z]))z=0}if(z)u=u.substring(0,x)+s.rep(escape(v),'+','%2B')+u.substring(y+1);x=y}}}return u};m.get=fu"
+"nction(u,v){var p=this,m=p._m;if(!p.disable){if(!v)v='s_'+m._in+'_Integrate_'+p._n+'_get_'+p._c;p._c++;p.VAR=v;p._d++;m.s.loadModule('Integrate:'+v,m._fu(p,u),0,1,p._n)}};m.delay=function(){var p=t"
+"his;if(p._d<=0)p._d=1};m.ready=function(){var p=this,m=p._m;p._d=0;if(!p.disable)m.s.dlt()};m._d=function(){var m=this,i,p;for(i=0;i<m.l.length;i++){p=m[m.l[i]];if(p&&!p.disable&&p._d>0)return 1}re"
+"turn 0};m._x=function(d,n){var p=this[n],x;if(!p.disable){for(x in d)if(x&&(!Object||!Object.prototype||!Object.prototype[x]))p[x]=d[x];p._d--}};m.beacon=function(u){var p=this,m=p._m,s=m.s,imn='s_"
+"i_'+m._in+'_Integrate_'+p._n+'_'+p._c,im;if(!p.disable&&s.d.images&&s.apv>=3&&(!s.isopera||s.apv>=7)&&(s.ns6<0||s.apv>=6.1)){p._c++;im=s.wd[imn]=new Image;im.src=m._fu(p,u)}};m.script=function(u){v"
+"ar p=this,m=p._m;if(!p.disable)m.s.loadModule(0,m._fu(p,u),0,1)};m.l=new Array;if(m.onLoad)m.onLoad(s,m)";
sc_obj.m_i("Integrate");
}

s_cbc_sitecatalyst_init(s_cbc_sitecatalyst);
